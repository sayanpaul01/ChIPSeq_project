...
## **📌 Total, Mapped, Unmapped, and Deduplicated and uniquely mapped Reads per Sample**
...
## **📌 Total, Mapped, Unmapped, and Deduplicated and uniquely mapped Reads per Individual**
...
## **📌 Total, Mapped, Unmapped, and Deduplicated and uniquely mapped Reads per treatment**
...
## **📌 Total, Mapped, Unmapped, and Deduplicated and uniquely mapped Reads per sample type**
...
## **📌 Total, Mapped, Unmapped, and Deduplicated and uniquely mapped Reads per sample type and individuals**
...
## **📌 Comparison of VEH and DOX reads across ChIP and Input samples**
```{r dedup5, echo=TRUE, message=FALSE, warning=FALSE, fig.height=8, fig.width=14}
# ============================================================
# 📊 Comparison of VEH and DOX read metrics across ChIP/Input samples
# ============================================================
...
long5 <- map %>%
  ...
  droplevels() %>%
  mutate(Reads = ifelse(Reads < 0, 0, Reads))  # Clamp negatives to 0
...
ggplot(long5, aes(x = Metric, y = Reads)) +
  ...
  coord_cartesian(ylim = c(0, NA)) +  # Force y-axis start from 0
